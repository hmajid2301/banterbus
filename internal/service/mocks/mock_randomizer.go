...
func (_m *MockRandomizer) GetID() string {
	ret := _m.Called()
...
func (_c *MockRandomizer_GetID_Call) Return(_a0 string) *MockRandomizer_GetID_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockRandomizer_GetID_Call) RunAndReturn(run func() string) *MockRandomizer_GetID_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetRoomCode provides a mock function with given fields:
