...
func Index() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<p>Start</p></button> <button class=\"flex flex-row justify-center items-center p-3 space-x-2 w-full text-3xl text-black rounded-lg rounded-b-lg font-button shadow-custom-border fill-transparent bg-text2\" @click=\"action = JSON.stringify({ message_type: &#39;join_lobby&#39; })\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
