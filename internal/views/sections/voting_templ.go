...
func Voting(state service.VotingState, currentPlayer service.PlayerWithVoting) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(" / 3</div><div class=\"text-right\"><div class=\"flex justify-center items-center w-16 h-16 rounded-full border-2 border-blue-500\"><p x-text=\"timer\"></p></div></div><div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		for _, player := range state.Players {
			if currentPlayer.ID.String() == player.ID.String() {
				...
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" alt=\"avatar\" class=\"w-full h-full rounded-full\"></div>Answer ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
		...
		for _, player := range state.Players {
			if currentPlayer.ID.String() != player.ID.String() {
				...
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" alt=\"avatar\" class=\"w-full h-full rounded-full\"></div><p>Answer ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</p><p class=\"text-center\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
