...
type Querier interface {
	...
	GetCurrentQuestionByPlayerID(ctx context.Context, playerID string) (GetCurrentQuestionByPlayerIDRow, error)
	...
	GetPlayerAnswerIsReady(ctx context.Context, playerID string) ([]GetPlayerAnswerIsReadyRow, error)
	...
	ToggleAnswerIsReady(ctx context.Context, id string) (FibbingItAnswer, error)
