...
type Querier interface {
	...
	GetGameStateForUpdate(ctx context.Context, id uuid.UUID) (GameState, error)
	...
	UpdateGameStateIfInState(ctx context.Context, arg UpdateGameStateIfInStateParams) (GameState, error)
